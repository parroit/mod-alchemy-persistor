...
class Query(object):
    ...
    def enable_eagerloads(self, value):
        ...
        When set to False, the returned Query will not web.ctx.render
    ...
    def union(self, *q):
        ...
        :class:`.Query` object will not web.ctx.render ORDER BY within
        ...
        for arg1 in util.to_list(keys):
            ...
            if isinstance(onclause, interfaces.PropComparator):
                ...
                if not create_aliases:
                    ...
                    # don't web.ctx.render in that case.

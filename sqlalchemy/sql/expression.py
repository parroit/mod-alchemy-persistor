...
def select(columns=None, whereclause=None, from_obj=[], **kwargs):
    ...
    :param distinct=False:
      ...
      is understood by the Postgresql dialect to web.ctx.render the
...
class Select(_SelectBase):
    ...
    def with_hint(self, selectable, text, dialect_name='*'):
        ...
        *selectable* argument. The dialect implementation
        ...
        with the token ``%(name)s`` to web.ctx.render the name of
    ...
    def distinct(self, *expr):
        ...
        :param \*expr: optional column expressions.  When present,
         the Postgresql dialect will web.ctx.render a ``DISTINCT ON (<expressions>>)``
         construct.

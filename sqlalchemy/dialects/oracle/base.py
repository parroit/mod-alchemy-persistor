...
* the values passed for the limit/offset are sent as bound parameters.   Some users have observed
  ...
  rendered literally.   To web.ctx.render the limit/offset values literally within the SQL
...
class OracleCompiler(compiler.SQLCompiler):
    ...
    def returning_clause(self, stmt, returning_cols):
        ...
        # within_columns_clause =False so that labels (foo AS bar) don't web.ctx.render
